...
export const updateSortTypeConfig = (sortType: TSortType) =>
  setToStorage(SORT_TYPE_KEY, sortType)
...
export const updateCompanyConfig = (companies: TCompany[]) =>
  setToStorage(COMPANY_KEY, companies.join(','))
...
export const updateIsOpenLinkNewTabConfig = (isOpenLinkNewTab: boolean) =>
  localStorage.setItem(
    IS_OPEN_LINK_NEW_TAB_KEY,
    isOpenLinkNewTab ? 'true' : 'false'
  )
