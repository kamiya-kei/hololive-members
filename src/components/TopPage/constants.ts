...
export const vTubers: TVtuber[] = [
  ...
  },
  {
    key: 'achichi-mela',
    name: '熱千めら',
    debuts: [{ date: '2026-09-24 19:00', description: 'デビュー日' }],
    birthday: '4/16',
    height: 149,
    other: '',
    group: 'アソビ★まわり隊！',
    company: 'hololive',
    sort: 109.0,
    twitter: 'https://x.com/achichi_mela',
    youtube: 'https://www.youtube.com/@AchichiMela',
    illustrator: [
      {
        name: '南野あき',
        twitter: 'https://x.com/_poo_illust',
      },
    ],
  },
  {
    key: 'sorashina-sopia',
    name: '宙科そぴあ',
    debuts: [{ date: '2026-09-24 20:00', description: 'デビュー日' }],
    birthday: '6/13',
    height: 153,
    other: '',
    group: 'アソビ★まわり隊！',
    company: 'hololive',
    sort: 109.01,
    twitter: 'https://x.com/sorashina_sopia',
    youtube: 'https://www.youtube.com/@SorashinaSopia',
    illustrator: [
      {
        name: '塩かずのこ',
        twitter: 'https://x.com/Siokazunoko',
      },
    ],
  },
  {
    key: 'suzuna-tsuzuri',
    name: '鈴鳴つづり',
    debuts: [{ date: '2026-09-25 19:00', description: 'デビュー日' }],
    birthday: '6/28',
    height: 155,
    other: '',
    group: 'アソビ★まわり隊！',
    company: 'hololive',
    sort: 109.02,
    twitter: 'https://x.com/suzuna_tsuzuri',
    youtube: 'https://www.youtube.com/@SuzunaTsuzuri',
    illustrator: [
      {
        name: 'necömi',
        twitter: 'https://x.com/necomi_info',
      },
    ],
  },
  {
    key: 'hyakuto-kyoko',
    name: '百灯キョーコ',
    debuts: [{ date: '2026-09-25 20:00', description: 'デビュー日' }],
    birthday: '5/8',
    height: 162,
    other: '',
    group: 'アソビ★まわり隊！',
    company: 'hololive',
    sort: 109.03,
    twitter: 'https://x.com/hyakuto_kyoko',
    youtube: 'https://www.youtube.com/@HyakutoKyoko',
    illustrator: [
      {
        name: '松尾省吾',
        twitter: 'https://x.com/shogo_matsuo',
      },
    ],
  },
  {
  ...
  },
  {
    key: 'yubari_rei',
    name: '悠針れい',
    debuts: [{ date: '2025-07-04', description: 'デビュー日' }],
    birthday: '11/23',
    height: 164,
    other: '',
    group: '個人勢',
  ...
  },
  {
    key: 'shiina-yuika',
    name: '椎名唯華',
    debuts: [{ date: '2018-07-30', description: 'デビュー日' }],
    birthday: '4/17',
    height: 153,
    other: 'しぃしぃ',
    group: 'にじさんじ',
    company: 'nijisanji',
    sort: 2.02,
    twitter: 'https://x.com/yuika_siina',
  ...
  },
  {
    ...
    company: 'nijisanji',
    sort: 2.03,
    twitter: 'https://x.com/makaino_ririmu',
  ...
  },
  {
    ...
    name: '星川サラ',
    debuts: [
      { date: '2019-10-17', description: 'デビュー日' },
      { date: '2019-10-19', description: '初配信日' },
    ],
    birthday: '8/7',
    height: 155,
    other: '制服衣装時は147cm',
    ...
    company: 'nijisanji',
    sort: 2.04,
    twitter: 'https://x.com/Sara_Hoshikawa',
    twitterSub: 'https://x.com/Hoshikawa_sub',
    youtube: 'https://www.youtube.com/channel/UC9V3Y3_uzU5e-usObb6IE1w',
    illustrator: [
      {
        name: '米白粕',
        twitter: 'https://x.com/kasu1923',
      },
    ],
  },
  {
    key: 'kizuna_ai',
    name: 'キズナアイ',
    debuts: [{ date: '2016-11-29', description: 'デビュー日' }],
    birthday: '6/30',
    height: 156,
    other: '',
    group: '個人勢',
    company: 'individual',
    sort: 3.0,
    twitter: 'https://x.com/aichan_nel',
    youtube: 'https://www.youtube.com/@AIChannel',
  },
  {
    key: 'natori_sana',
    name: '名取さな',
    debuts: [{ date: '2018-03-16', description: 'デビュー日' }],
    birthday: '3/7',
    height: 152,
    other: '',
    group: '個人勢',
    company: 'individual',
    sort: 3.01,
    twitter: 'https://x.com/sana_natori',
    youtube: 'https://www.youtube.com/@sana_natori',
  },
  {
    key: 'hime_hina',
    name: '田中ヒメ/鈴木ヒナ',
    debuts: [{ date: '2018-03-18', description: 'デビュー日' }],
    birthday: '99/99',
    height: 147,
    other: '',
    group: '個人勢',
    company: 'individual',
    sort: 3.02,
    twitter: 'https://x.com/HimeTanaka_HH',
    youtube: 'https://www.youtube.com/@HimeHina',
  },
  {
    key: 'yoruno-kuromu',
    name: '夜乃くろむ',
    debuts: [{ date: '2023-11-24 21:00', description: 'デビュー日' }],
    birthday: '6/6',
    height: 150,
    other: 'うみんぐ',
    group: 'ぶいすぽっ！',
    company: 'vspo',
    sort: 3.03,
    twitter: 'https://x.com/kuromu_yano',
    youtube: 'https://www.youtube.com/@YanoKuromu',
  },
  {
    key: 'kurikoma-komaru',
    name: '栗駒こまる',
    debuts: [{ date: '2021-08-14', description: 'デビュー日' }],
    birthday: '9/25',
    height: 152,
    other: '',
    group: 'あおぎり高校',
    company: 'aogiri',
    sort: 3.04,
    twitter: 'https://x.com/kurikoma_komaru',
    youtube: 'https://www.youtube.com/channel/UCXXnWssOLdB2jg-4CznteAA',
  },
  // {
  //   key: 'key',
  //   name: 'name',
  //   debuts: [{ date: '2000-99-99', description: 'デビュー日' }],
  //   birthday: '99/99',
  //   height: 999,
  //   other: '',
  //   group: '個人勢',
